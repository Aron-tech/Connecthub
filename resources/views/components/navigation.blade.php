    ...
    <ul class="flex items-center space-x-6">
      ...
      <li>
        ...
        <li class="relative group">
            ...
            <ul class="absolute hidden group-hover:block mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100 group-hover:delay-150">
                <li>
      ...
      <li>
        <form action="/logout" method="POST">
          @csrf
          <button class="rounded-md py-2 text-sm font-medium  text-gray-700 hover:text-blue-600" type="submit">Kijelentkezik</button>
        </form>
      </li>
      @endauth
